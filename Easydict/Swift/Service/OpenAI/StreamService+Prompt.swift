...
extension StreamService {
    ...
    private func translationPrompt(
        ...
        -> String {
        "Translate to \(targetLanguage.queryLanguageName) Language (output translation only):\n\n\(text)"
    }
